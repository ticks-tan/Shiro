...
import { useHomePageData } from './data-provider'

// @ts-expect-error
export const MotionDiv: ForwardRefComponent<
  HTMLDivElement,
  HTMLMotionProps<'div'>
> = (props: any) => {
  return <m.div {...props} />
...
export const PostScreen = () => {
  const posts = useHomePageData((data) => data.posts)
...
export const NoteScreen = () => {
  const notes = useHomePageData((data) => data.notes)
